...
public class LoggingAspect {
    ...
    @AfterReturning(value = "execution(* it.gov.pagopa.spontaneouspayment.controller..*.*(..))", returning = "result")
    ...
    @Around(value = "execution(* it.gov.pagopa.spontaneouspayment.repository..*.*(..)) || execution(* it.gov.pagopa.spontaneouspayment.service..*.*(..))")
    ...
    @Before(value = "execution(* it.gov.pagopa.spontaneouspayment.repository..*.*(..)) || execution(* it.gov.pagopa.spontaneouspayment.service..*.*(..))")
